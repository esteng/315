...
for i in range(0, 71, 10):
    r = 0
    with open("/Users/Elias/315/A2/results/my_learnability/my_learnability={}/output-epochs".format(i)) as f1:
        lines = f1.readlines()
        newlines = []
        for line in lines:
...
f2cw= csv.writer(f2)
f2cw.writerow([x*10 for x in range(0, 8)]+[y for y in range(75, 101, 5)])
