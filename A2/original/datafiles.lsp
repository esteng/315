;;;file: continuous-xor-cessation-learnability datafiles 315.cl
;;;purpose: construct datafiles for Excel & SPSS from lisp output files
;;;programmer: Thomas R. Shultz
;;;started: 11 aug 2012
;;;current: 18 aug 2012

;;;Consolidating datafiles
;;;Use file->list (in SDCC) to read file. 
;;;Generate folder names & column entries for condition values. 
;;;Construct a list of condition names for each network & its network # & dependent variable valuable, 
;;;  & join these lists together using list. 
;;;Keep appending these lists across conditions
;;;  & store them with lists->file on reverse list. 
